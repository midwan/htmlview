...
static const char *test_html =
    ...
    "</article>"
    "<nav>Nav: <a href=\"#\">Home</a> &middot; <a href=\"#\">About</a></nav>"
    "<figure>"
    "<img src=\"PROGDIR:test.png\" alt=\"figure image\" width=\"48\">"
    "<figcaption>Figcaption beneath the figure image.</figcaption>"
    "</figure>"
